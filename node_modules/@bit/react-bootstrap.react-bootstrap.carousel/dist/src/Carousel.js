...
function (_React$Component) {
  ...
  function Carousel(props, context) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Carousel).call(this, props, context));

    _defineProperty(_assertThisInitialized(_this), "handleSlideEnd", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleNextWhenVisible", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePrev", function (e) {
      if (_this._isSliding) return;
  ...
  _createClass(Carousel, [{
    ...
    key: "safeSetState",
    value: function safeSetState(state, cb) {
      var _this3 = this;
    ...
    value: function render() {
      var _this$props4 = this.props,
          ...
          props = _objectWithoutProperties(_this$props4, ["bsPrefix", "slide", "fade", "indicators", "controls", "wrap", "prevIcon", "prevLabel", "nextIcon", "nextLabel", "className", "children", "keyboard", "activeIndex", "pauseOnHover", "interval", "onSelect", "onSlideEnd"]);
      ...
      return (// eslint-disable-next-line jsx-a11y/no-static-element-interactions
        _react.default.createElement("div", _extends({}, props, {
          className: (0, _classnames.default)(className, bsPrefix, slide && 'slide', fade && "".concat(bsPrefix, "-fade")),
          ...
          return (0, _react.cloneElement)(child, {
            className: (0, _classnames.default)(child.props.className, "".concat(bsPrefix, "-item"), current && currentClasses, previous && prevClasses)
          });
